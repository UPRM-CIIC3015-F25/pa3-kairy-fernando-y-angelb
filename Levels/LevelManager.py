...
class LevelManager():
    ...
    def setUpLevels(self): # Sets up all levels and sublevels
        self.levelsDict = {
            ...
            2: [
                ...
                SubLevel(Blind.BOSS, 2, "The Needle")
            ],
            3: [
            ...
            5: [
                ...
                SubLevel(Blind.BOSS, 5, "The Water")
            ],
            6: [
                SubLevel(Blind.SMALL, 6),
                SubLevel(Blind.BIG, 6),
                SubLevel(Blind.BOSS, 6, "The Manacle")
            ],
        }
    ...
    # TASK 8 - Recursive function that finds the next unfinished sublevel
    def next_unfinished_sublevel(self, index=0):
        # base case
        if index >= len(self.curLevel):
            return None

        # if sublevel isn't finished return it
